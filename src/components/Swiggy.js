const Swiggy = () =>{
    ...
    return(
        <section className = "projects-detail-bg nick-bgs">
            ...
            <h3 className = "banner-name-text text-center pt-5 pb-5" data-aos="fade-down">Nature's table</h3>
